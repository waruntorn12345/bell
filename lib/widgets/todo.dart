...
import 'package:travel_hour/pages/guide1.dart';
import 'package:travel_hour/pages/guide2.dart';
            ...
            children: <Widget>[
              ...
              InkWell(
                child: Container(
                    padding: EdgeInsets.all(15),
                    decoration: BoxDecoration(
                      color: Color.fromARGB(255, 95, 185, 11),
                      borderRadius: BorderRadius.circular(10),
                    ),
                    child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                ...
                onTap: () => nextScreen(context, GuidePage1(d: placeData)),
              ),
              InkWell(
                child: Container(
                    padding: EdgeInsets.all(15),
                    decoration: BoxDecoration(
                      color: Color.fromARGB(255, 243, 30, 197),
                      borderRadius: BorderRadius.circular(10),
                    ),
                    child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                ...
                onTap: () => nextScreen(context, GuidePage2(d: placeData)),
              ),
              // InkWell(
              //   child: Container(
              //       padding: EdgeInsets.all(15),
